...
export const projects = [
  ...
  {
    id: 2,
    title: "AI/ML Data Predictor",
    category: "AI/ML",
    description:
      "An intelligent data analysis and prediction system powered by machine learning algorithms with Pandas-based data processing, real-time insights and predictive analytics.",
    longDescription:
      "A comprehensive ML platform built with Python that processes datasets, trains multiple models, and visualizes predictions with interactive charts and performance metrics.",
    image: null,
    gradient: "from-blue-600 to-cyan-500",
    tags: ["Python", "Machine Learning", "Pandas", "Data Analysis", "GCP"],
